        ...
        <footer className="footer footer-center p-10 bg-base-100 text-base-content rounded">
            ...
            <div>
                <div className="grid grid-flow-col gap-4">
                    <Link className="rounded bg-primary p-2 hover:bg-secondary duration-300 drop-shadow-lg" href="https://www.instagram.com/arquidomord/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-white" viewBox="0 0 448 512">
                    ...
                    <Link className="rounded bg-primary p-2 hover:bg-secondary duration-300 drop-shadow-lg" href={"mailto:info@arquidomo.com"} target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </svg>
                    </Link>

                    <Link className="rounded bg-primary p-2 hover:bg-secondary duration-300 drop-shadow-lg" href={"https://www.wa.link/x0ykhc"} target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-white" viewBox="0 0 448 512">
